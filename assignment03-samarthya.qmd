...
#| fig-cap: "Histogram showing the distribution of salary data from a representative sample of the dataset. The visualization demonstrates the right-skewed nature of salary distributions, with most positions clustered in lower salary ranges and a long tail extending to higher compensation levels. This sampling approach ensures statistical validity while maintaining computational efficiency for large-scale data analysis."
