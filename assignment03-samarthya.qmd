...
def display_figure(fig, filename_base):
    """Display figure as interactive for HTML, static image for PDF/DOCX"""
    from IPython.display import Image, display

    output_format = get_output_format()

    if "html" in output_format:
        # For HTML output, display the interactive plot directly
        ...
        # For all other formats (PDF, DOCX), save a static image
        static_filename = f"images/{filename_base}_static.png"
        fig.write_image(static_filename, width=1400, height=800, scale=2)
        # Display the static image
        display(Image(filename=static_filename))
        print(f"✓ Static image saved: {static_filename}")
...
# Rule 2: Impute missing SALARY values with occupation + employment type specific medians
...
print("=== VERIFYING SALARY DIVERSITY AFTER IMPROVED IMPUTATION ===")
...
print(f"\n=== FINAL RESULTS WITH IMPROVED IMPUTATION ===")
