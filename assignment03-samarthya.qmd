...
print("✓ Renderers configured for both interactive and static output")
...
def display_figure(fig, filename_base):
    ...
    # Since QUARTO_OUTPUT_FORMAT is not reliably set, we'll use a different approach
    # We'll always display both static and interactive versions
    # Quarto will choose which one to use based on the output format

    # Display static image (for PDF/DOCX)
    print(f"✓ Static image available: images/{filename_base}.png")

    # Display interactive figure (for HTML)
    print(f"✓ Interactive figure available for HTML")
    fig.show()
